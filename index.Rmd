...
The best model has k = 1 and an accuracy of ~ 0.9940. This predicts the entire training data set perfectly, albeit with the risk of the model being overfit.
...
The decision tree does poorly. It never predicts a classe of D and has an accuracy of ~ 0.5057.
...
Random forest does better than k-NN. Accuracy is 0.9955 and it also predicts the entire training set perfectly.
